...
import com.beautyFaceunity.gles.ProgramTexture2dWithAlpha;
import com.beautyFaceunity.gles.ProgramTextureOES;
...
public class BitmapUtil {
  ...
  public static void glReadBitmap(
    ...
    GLES20.glFramebufferTexture2D(
        GLES20.GL_FRAMEBUFFER, GLES20.GL_COLOR_ATTACHMENT0, GLES20.GL_TEXTURE_2D, textures[0], 0);
  ...
  public static Bitmap decodeSampledBitmapFromStream(
      InputStream isForBounds, InputStream isForData, int reqWidth, int reqHeight) {
