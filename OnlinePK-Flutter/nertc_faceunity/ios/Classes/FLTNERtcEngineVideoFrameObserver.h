...
#ifndef FLTNERtcEngineVideoFrameObserver_h
#define FLTNERtcEngineVideoFrameObserver_h

#endif /* FLTNERtcEngineVideoFrameObserver_h */
 ...
 */
@protocol FLTNERtcEngineVideoFrameObserver <NSObject>
