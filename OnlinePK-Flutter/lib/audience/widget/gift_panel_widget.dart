...
class _GiftPanelWidgetState extends LifecycleBaseState<GiftPanelWidget> {
  ...
  final _giftList = [
    GiftInfo(1, Strings.bizLiveGlowStick, 9, AssetName.gift01,
        AssetName.lottieGift01),
    GiftInfo(2, Strings.bizLiveArrange, 99, AssetName.gift02,
        AssetName.lottieGift02),
    GiftInfo(3, Strings.bizLiveSportsCar, 199, AssetName.gift03,
        AssetName.lottieGift03),
    GiftInfo(4, Strings.bizLiveRockets, 999, AssetName.gift04,
    ...
    return GestureDetector(
      child: Container(
          ...
          decoration: isSelected(giftInfo)
              ? BoxDecoration(
                  border: Border.all(color: AppColors.colorFf337eff, width: 2),
          ...
          child: Column(
            children: [
              ...
              Text(
                sprintf(Strings.bizLiveZeroCoin, [giftInfo.coinCount]),
                style: const TextStyle(
                  fontSize: 12,
