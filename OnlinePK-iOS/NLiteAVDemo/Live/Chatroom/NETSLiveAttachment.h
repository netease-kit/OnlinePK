...
/**
 惩罚阶段消息序列化
 */
@interface NETSLivePKAttachment : NSObject<NIMCustomAttachment>

@property (nonatomic, assign)   NETSLiveAttachmentType  type;
...
// 结束 pk 结果，1:当前观众所在房间主播胜利, 0:平局, -1:失败，state 为 0 时忽略
@property (nonatomic, assign)   int32_t                 currentAnchorWin;
