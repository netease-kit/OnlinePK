    ...
    switch (message.messageType) {
        case NIMMessageTypeCustom:
        {
            ...
            if ([object.attachment isKindOfClass:[NETSLivePKAttachment class]]) {
                NETSLivePKAttachment *attach = (NETSLivePKAttachment *)object.attachment;
                if (attach.type == NETSLiveAttachmentPkType && _delegate && [_delegate respondsToSelector:@selector(didReceivedPKMessage:)]) {
                    [_delegate didReceivedPKMessage:message];
                }
                if (attach.type == NETSLiveAttachmentPunishType && _delegate && [_delegate respondsToSelector:@selector(didReceivedPunishMessage:)]) {
