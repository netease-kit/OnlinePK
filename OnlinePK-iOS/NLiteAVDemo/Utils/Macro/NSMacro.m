...
NSString * _logBaseInfo(NSString *moduleName) {
    ...
    NSString *nertcVersion = [NSBundle bundleForClass:[NERtcEngine class]].infoDictionary[@"CFBundleShortVersionString"] ?: @"";
...
#endif
    opts.filePrefix = @"log";
    opts.moduleName = @"online_pk";
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    opts.path = [paths.firstObject stringByAppendingPathComponent:@"/online_pk"];
